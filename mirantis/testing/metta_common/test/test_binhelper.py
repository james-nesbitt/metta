...
# line-length management would make this unreadable
            ...
            "platforms": {
                "Linux-x86_64": {
                    ...
                    "launchpad": {
                        ...
                        "version": "1.2.0-rc.1",
                        "copy": {"launchpad": "launchpad-linux-x64"},
                    },
                    "helm": {
                        "url": "https://get.helm.sh/helm-v3.5.3-linux-amd64.tar.gz",
                        "version": "v3.5.3",
                        "copy": {"helm": "linux-amd64/helm"},
                    },
                    "terraform": {
...
class BinHelperTest(unittest.TestCase):
    """Test suite for testing the binhelper metta_common module."""

    config: Dict[str, Any] = {}
    """ config as a dict, to be used to configure environments for testing """
    temp_bin_dir: str = ""
    """ string path to a folder which bin-helper should download bins to """
