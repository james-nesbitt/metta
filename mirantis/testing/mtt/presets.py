...
MTT_PRESETS = [
    ("variation", pkg_resources.resource_filename(
        "mirantis.testing.mtt", "config/variation"), 0),
    ("cluster", pkg_resources.resource_filename(
        "mirantis.testing.mtt", "config/cluster"), 1),
    ("platform", pkg_resources.resource_filename(
        "mirantis.testing.mtt", "config/platform"), 1),
    ("release", pkg_resources.resource_filename(
        "mirantis.testing.mtt", "config/release"), 1)
]
