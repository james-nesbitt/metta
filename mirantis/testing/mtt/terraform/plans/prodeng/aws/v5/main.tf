...
locals {
  ...
  tags_all           = {
    (module.common.kube_cluster_tag)  = "shared"
    "project"                         = var.project
    "expire"                          = local.expire
    "username"                        = var.username
    "task_name"                       = var.task_name
  ...
  machines = concat(module.managers.machines, module.workers.machines, module.msrs.machines, module.windows_workers.machines)
  hosts = [
    for host in local.machines : {
      ssh = {
