...
def metta_plugin_factory_workload_litmuschaos(environment: Environment, instance_id: str = '', label: str = LITMUSCHAOS_WORKLOAD_CONFIG_LABEL, base: Any = LITMUSCHAOS_WORKLOAD_CONFIG_BASE):
