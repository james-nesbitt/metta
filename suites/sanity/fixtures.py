...
Centralize Fixtures so that they can be used without pytest
...
def config():
    ...
    config = uctt.new_config(additional_uctt_bootstraps=[
        'uctt_docker',
        'uctt_kubernetes',
        'mtt'
    ])
...
def provisioner(config, instance_id='ltc_provisioner'):
