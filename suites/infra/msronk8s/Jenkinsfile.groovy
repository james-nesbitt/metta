            ...
            steps {
                container('workspace') {
                    script {
                        ...
                        dir("suites/${env.CHANNEL}/${env.SUITE}") {
                            ...
                            currentBuild.displayName = "${env.SUITE} (${GIT_TAG}) ${env.BUILD_DISPLAY_NAME}"
                    ...
                    stage('Execute') {
                        environment {
                            ...
                            METTA_VARIABLES_ID="ci-${env.SUITE}-${env.BUILD_NUMBER}"
                            METTA_USER_ID="ci"
                        }
                        steps {
                            container('workspace') {
                                        ...
                                        withCredentials([
                                            ...
                                            usernamePassword(credentialsId: 'testeng-dockerhub-up', usernameVariable: 'REGISTRY_USERNAME', passwordVariable: 'REGISTRY_PASSWORD')
                                                ...
                                                try {
                                                    ...
                                                    sh(
                                                        label: "Running ${env.SUITE}",
                                                        script: """
                                                            python -m manage.start
                                                        """
                                                    )
