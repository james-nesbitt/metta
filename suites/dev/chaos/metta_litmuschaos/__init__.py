...
from .litmuschaos_workload import (LitmusChaosWorkloadPlugin, METTA_PLUGIN_ID_LITMUSCHAOS_WORKLOAD,
...
@Factory(plugin_type=METTA_PLUGIN_TYPE_WORKLOAD, plugin_id=METTA_PLUGIN_ID_LITMUSCHAOS_WORKLOAD)
...
@Factory(plugin_type=METTA_PLUGIN_TYPE_CLI, plugin_id=METTA_PLUGIN_ID_LITMUSCHAOS_CLI)
