...
from mirantis.testing.metta_mirantis.mke_client import (
    MKEAPIClientPlugin, METTA_MIRANTIS_CLIENT_MKE_PLUGIN_ID)
from mirantis.testing.metta_mirantis.msr_client import (
    MSRAPIClientPlugin, METTA_MIRANTIS_CLIENT_MSR_PLUGIN_ID)
...
def stability_workload(
        environment_after_up: Environment) -> KubernetesDeploymentWorkloadPlugin:
