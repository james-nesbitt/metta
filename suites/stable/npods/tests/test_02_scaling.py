...
def _create_scale_and_test_function(scale):
    ...
    def _scale_and_test(environment_up_unlocked, mke, kubeapi, loki, npods, npods_config):
        ...
        logger.info("scaling test harness %s : %s+ (replicas) / %s+ (threads)",
...
def _create_scale_down_and_test_function():
    ...
    # pylint: disable=too-many-arguments, unused-argument
    def scale_down_and_test(environment_up_unlocked, mke, kubeapi, loki, npods, npods_config):
        ...
        try:
            stability_test(environment=environment_up_unlocked,
                           mke=mke, kubeapi=kubeapi,
                           npods_config=npods_config,
...
test_01_0500 = _create_scale_and_test_function(
    {'replicas': 500, 'threads': 500})
""" Initial scale up to 500 pods """
test_02_1000 = _create_scale_and_test_function(
    {'replicas': 500, 'threads': 500})
""" Scale up to 1000 pods """
test_03_1500 = _create_scale_and_test_function(
    {'replicas': 500, 'threads': 500})
""" Scale up to 1500 pods """
test_04_2000 = _create_scale_and_test_function(
    {'replicas': 500, 'threads': 500})
""" Scale up to 2000 pods """
test_05_2250 = _create_scale_and_test_function(
    {'replicas': 250, 'threads': 250})
""" Scale up to 2250 pods """
test_06_2500 = _create_scale_and_test_function(
    {'replicas': 250, 'threads': 250})
""" Scale up to 2500 pods """
test_05_2750 = _create_scale_and_test_function(
    {'replicas': 250, 'threads': 250})
""" Scale up to 2750 pods """
test_05_3000 = _create_scale_and_test_function(
    {'replicas': 250, 'threads': 250})
